...
export default class AboutSectionClass {
  ...
  initMeth() {
    if (!this.parentDom)
      console.error(
        "About section is not present in main HTML, please add it!"
      );
  ...
  drawSectionMeth() {
    ...
    buttonDom.href =
      "//wp.regaltheme.com/mim/wp-content/uploads/2017/06/Basic_Curriculum_Vitae_example.pdf";
    ...
    skills_data_Arr.forEach((skillPar) => {
